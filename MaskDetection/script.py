...
mouth_cascade = cv2.CascadeClassifier('../hc/Mouth.xml')
...
thickness = 2
font_scale = 1
weared_mask = "Com mascara"
not_weared_mask = "Sem mascara"
...
while not cv2.waitKey(20) & 0xFF == ord('q'):
    ...
    if(len(faces) == 0 and len(faces_bw) == 0):
        cv2.putText(img, "Nenhum rosto encontrado ", org, font, font_scale, noface, thickness, cv2.LINE_AA)
